...
import { IconAlertSquareRounded, IconCirclePlus, IconDatabaseOff, IconPencilCog, IconTrash } from '@tabler/icons-react'
                        ...
                        {products.data.length ?
                            products.data.map((product, i) => (
                                <tr className='hover:bg-gray-100 dark:hover:bg-gray-900' key={i}>
                                    ...
                                    <Table.Td>
                                        <div className={`${product.stock < 10 ? 'rounded-lg bg-red-500 text-white': ''} w-10 flex items-center justify-center`}>
                                            {product.stock}
                                        </div>
                                    </Table.Td>
                                    <Table.Td>
