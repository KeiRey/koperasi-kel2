                    ...
                    <div
                        className={`${
                            isToggle
                                ...
                                : "-translate-x-full"
                        } flex flex-col fixed top-0 left-0 z-50 w-[300px] h-full transition-all duration-300 transform border-r bg-white dark:bg-gray-950 dark:border-gray-900`}
                    >
                        <div className="flex justify-center items-center px-6 py-2 h-16">
                            <div className="text-2xl font-bold flex items-center gap-2 text-center leading-loose tracking-wider text-gray-900 dark:text-gray-200">
                            <img
                                alt="Your Company"
                                src="/assets/logo/logo-sekolah.png"
                                className="mx-auto h-8 aspect-square"
                            />
                            <span>KASIR</span>
                            </div>
                        </div>
                        ...
                        <div className="w-full flex flex-col overflow-y-auto flex-1">
                            ...
                            <button
                                onClick={logout}
                                className="flex flex-1 items-end mb-2 font-medium gap-x-3.5 px-4 py-3 hover:border-r-2 capitalize hover:cursor-pointer text-sm text-gray-500 hover:border-r-gray-700 hover:text-gray-900 dark:text-gray-500 dark:hover:border-r-gray-50 dark:hover:text-gray-100"
                            >
