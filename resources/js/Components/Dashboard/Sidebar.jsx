...
export default function Sidebar({ sidebarOpen }) {
    ...
    return (
        <div
            ...
            } hidden md:block min-h-screen overflow-y-auto border-r transition-all duration-300 bg-white dark:bg-gray-950 dark:border-gray-900`}
        >
            {sidebarOpen ? (
                <>
                    <div className="flex justify-center items-center px-6 py-2 h-16">
                        <div className="text-2xl font-bold text-center leading-loose flex items-center gap-2 tracking-wider text-gray-900 dark:text-gray-200">
                            <img
                                alt="Your Company"
                                src="/assets/logo/logo-sekolah.png"
                                className="mx-auto h-10 aspect-square"
                            />
                            <span>KASIR</span>
                        </div>
                    </div>
